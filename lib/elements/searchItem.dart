...
Widget getSearchItem(
    BuildContext context,
    int _mediaId,
    String _mediaTitle,
    String _mediaOriginalTitle,
    String _mediaImageUrl,
    String _mediaReleaseYear,
    ...
    child: Stack(alignment: AlignmentDirectional.bottomStart, children: [
      Center(
        child: Container(
          ...
          height: _imageWidth / 9 * 16 - 2 * _offset,
          ...
          child: Hero(
            ...
            child: Image(
                ...
                image: _mediaImageUrl != null
                    ? NetworkImage(
                        "https://image.tmdb.org/t/p/w500" + _mediaImageUrl)
                    : AssetImage('assets/empty_poster.jpg')),
          ),
          //margin: EdgeInsets.all(_imageOffset),
          margin: EdgeInsets.fromLTRB(
              _offset * 1.5, _offset, _offset, _offset)),
    ]),
  ));
}
