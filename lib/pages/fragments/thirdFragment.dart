...
class ThirdFragment extends StatefulWidget {
  @override
  State<ThirdFragment> createState() => _ThirdFragmentState();
}
  ...
  void initState() {
    ...
    scrollController.addListener(() {
      if (scrollController.position.pixels == scrollController.position.maxScrollExtent) {
        homeController.fetchNextData(2);
      }
    });
                    ...
                    children: [
                      DropdownButton(
                        ...
                        onChanged: (val) {
                          ...
                          controller.fetchNewData(2);
                        },
                        items: [
                          DropdownMenuItem(
                            value: "popularity",
                            child: Row(
                              children: [Icon(Icons.whatshot), Text(" Žhavé")],
                            ),
                          ),
                          DropdownMenuItem(
                            value: "vote_average",
                          ...
                          DropdownMenuItem(
                            ...
                            child: Row(
                              children: [Icon(Icons.sort_by_alpha_rounded), Text(" Abecedně")],
                            ),
                          ),
                        ],
                      ),
